    ...
    for n_steps in steps:
        for sigma in sigmas:
            ...
            for i in [n_steps - 1]:
                ...
                print('====================================')
                print(f'guided FID')
                subprocess.call(f"CUDA_VISIBLE_DEVICES=5 python3 guided-diffusion-main/evaluations/evaluator.py $INPUT_PATH/VIRTUAL_imagenet64_labeled.npz fid-tmp/array.npz", shell=True)
                print('====================================')
            print(
                '===============================================================================================================================')
